...
const Syllabus: React.FC = () => {
  const units = [
    {
      unit: 'יחידה 1', lessons: 'שיעורים 1-4', title: 'מבוא כללי וקרסול',
    ...
    {
      unit: 'יחידה 2', lessons: 'שיעורים 5-8', title: 'אגן, ירך וברך',
    ...
    {
      unit: 'יחידה 3', lessons: 'שיעורים 9-13', title: 'כתף, צוואר, ידיים וסרעפת',
    ...
    {
      unit: 'יחידה 4', lessons: 'שיעורים 14-18', title: 'הגוף כמערכת גלובלית (Anatomical Chains)',
  ...
  return (
    <section className="section section-bg-secondary" id="syllabus">
        ...
        <div className="syllabus-grid">
            ...
            {units.map((unit, idx) => (
              <div key={idx} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-light)', paddingBottom: '1rem', marginBottom: '1rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                  <h3 style={{ margin: 0, fontSize: '1.15rem' }}>{unit.unit}: {unit.title}</h3>
                  <span style={{ backgroundColor: 'var(--accent-secondary-bone)', padding: '4px 12px', borderRadius: 'var(--radius-lg)', fontSize: '0.85rem', fontWeight: 'bold', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>
                    {unit.lessons}
                  </span>
                </div>
          ...
          <div style={{ position: 'sticky', top: '2rem' }}>
            <div style={{ padding: '1rem', backgroundColor: 'var(--bg-primary)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}>
              ...
              <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: 0 }}>
